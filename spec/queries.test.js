...
describe('Query functions', function() {
  describe('locate', function() {
    it.only('Should return an array of filtered states', function() {
  ...
  describe('find_before', function() {
    it.only('Should return an array of companies less than or equal to input year', function() {
  ...
  describe('find_after', function() {
    it.only('Should return an array of companies greater than or equal to input year', function() {
  ...
  describe('find_companies_between_size', function() {
    it.only('Should return an array of companies at the input size', function() {
  ...
  describe('find_type', function() {
    ...
    it.only('Should not include companies with "NA" or "N/A" company_category', function() {
